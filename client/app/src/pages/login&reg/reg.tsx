...
const RegPage = () => {
  ...
  const handleGetCode = useCallback(() => {
    ...
    fetch(`${API_BASE_URL}/getcode?phone=${phone}`, {
      method: 'GET'
    })
  ...
  }, [username, phone, code, password, confirmPassword, isAgreed]);
  ...
  return (
    <div className="reg-page">
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <span className="tip">4-20个字符，可包含字母、数字、下划线</span>
            </div>
      ...
      <style>{`
        ...
        .btn-register .btn-hover-content {
          position: absolute;
          inset: 0;
          display: flex;
          align-items: center;
        ...
        .btn-register:hover:not(:disabled) .btn-text {
          transform: translateX(40px);
          opacity: 0;
        }

        .btn-register:hover:not(:disabled) .btn-hover-content {
          opacity: 1;
        }
